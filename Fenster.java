...
public class Fenster extends JFrame implements ActionListener
{
    ...
    public long HexInDec(String Param){
        ...
        /*
        if(newParam.startsWith("0x") == false){
        System.out.println("MCall HinD  WITHOUT 0x with Param:"+Param);
        if(isHex(newParam)){
        int priv = newParam.length()-1;
        for(int i=0;i<newParam.length();i++)
        {
        if(newParam.charAt(i) == '0')
        {
        x =  x+ (0*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '1')
        {
        x =  x+ (1*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '2')
        {
        x =  x+ (2*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '3')
        {
        x =  x+ (3*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '4')
        {
        x =  x+ (4*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '5')
        {
        x =  x+ (5*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '6')
        {
        x =  x+ (6*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '7')
        {
        x =  x+ (7*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '8')
        {
        x =  x+ (8*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == '9')
        {
        x =  x+ (9*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == 'A')
        {
        x =  x+ (10*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == 'B')
        {
        x =  x+ (11*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == 'C')
        {
        x =  x+ (12*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == 'D')
        {
        x =  x+ (13*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == 'E')
        {
        x =  x+ (14*((long)Math.pow(16,priv)));
        }
        if(newParam.charAt(i) == 'F')
        {
        x =  x+ (15*((long)Math.pow(16,priv)));
        }
        priv--;
